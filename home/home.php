...
<body>
    ...
    <main>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="main-title">Conheça nossos Cursos</h3>
                </div>
            </div>

            <!-- Puxa as informações dos cursos no BD-->
            <?php
            $query_cursos = "SELECT id, name, description, price, image FROM cursos ORDER BY id ASC";
                    ...
                    <div class="col">
                        <div class="card h-100">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">De: R$
                                    <?php echo number_format($price, 2, ",", "."); ?>
                                </li>
                                <li class="list-group-item">Para: Grátis</li>
                            </ul>
                            <div class="card-body">
                                <!-- Ao clicar no botão o id do curso é passado junto -->
                                <a href="detalhes.php?id='<?php echo $id; ?>'" class="btn btn-primary">Detalhes</a>
                            </div>
                        </div>
                    </div>
                    <?php
